#include "findbordercoordinatetest.h"
...
findBorderCoordinateTest::findBorderCoordinateTest(QObject *parent) : QObject(parent)
{

}

findBorderCoordinateTest::~findBorderCoordinateTest()
{

}

void findBorderCoordinateTest::test_data()
{
...
void findBorderCoordinateTest::test()
{
    ObstaclesList *d;
    QFETCH(void*, list);
    QFETCH(int, maxX);
